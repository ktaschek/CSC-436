...
import com.zybooks.petadoption.data.*
...
fun AdoptScreen(
   ...
   Scaffold(
      ...
      Column(
         ...
         Text(
            text = "Please pick up y" +
                    "our new family member during business hours.",
            modifier = modifier.padding(6.dp),
         )
         Button(
            onClick = { shareAdoption(context, pet) },            modifier = modifier.padding(6.dp)
         ) {
